...
DateTime now;
#define IN1 19; // select the INPUT pin for the BOARD
#define IN2 18;
#define IN3 5;
#define IN4 17;
#define IN5 16;
...
#define OUT1 12; // select the OUTPUT pin for the BOARD
#define OUT2 27;
#define OUT3 26;
#define OUT4 25;
#define OUT5 33;
...
int OUT[8] = [12,27,26,25,33,32,13,15];
...
void ledToggle(int o, int c)
{
  ...
  {
    LED_state[o - 1] = c == 1 ? 0 ;
    digitalWrite(ledToTurn, c == 1 ? HIGH : LOW);
    Serial.printf("Light toggled %4d and state = %2i", o, c);
    Serial.println();    
  }
  else {
    Serial.printf("this was out of range: %4d | %2i", o, c);
  }
